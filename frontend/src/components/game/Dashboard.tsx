      ...
      {recentStories.length > 0 && (
        <Card className="bg-daemon-panel border-2 border-daemon-gold shadow-gold-lg">
          <div className="flex items-center mb-4">
            ...
            <h3 className="font-header text-lg text-daemon-text-bright">
              📖 Recent Corporate Legends
            </h3>
          </div>
              ...
              <div
                ...
                className={`p-3 bg-daemon-surface rounded-lg border-l-4 ${
                  story.category === 'heroic'
                    ? 'border-l-daemon-info'
                    : story.category === 'tragic'
                      ? 'border-l-daemon-danger'
                      : story.category === 'absurd'
                        ? 'border-l-daemon-gold'
                        : 'border-l-daemon-warning'
                }`}
              >
