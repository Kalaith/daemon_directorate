...
export const CORPORATE_EVENTS = [
  {
    ...
    description: "Annual evaluations are being conducted. How do you handle the bureaucracy?",
    ...
    choices: [
      {
        ...
        effects: [
          ...
          { type: "bureaucraticLeverage", value: 3, description: "Gain bureaucratic favor" }
        ]
      },
      {
        ...
        effects: [
          { type: "morale", value: 10, description: "Daemons appreciate the cleverness" },
          { type: "credits", value: 150, description: "Efficiency bonus" },
          { type: "corruption_risk", value: 0.1, description: "10% chance of audit next turn" }
        ]
      }
    ]
  },
  {
    ...
    description: "Corporate is reshuffling departmental budgets. Do you lobby for more funding?",
    type: "choice" as const,
    choices: [
      {
        ...
        effects: [
          { type: "bureaucraticLeverage", value: -2, description: "Spend political capital" },
          { type: "credits", value: 400, description: "Secure additional funding" }
        ]
      },
      {
        ...
        effects: [
          { type: "credits", value: -150, description: "Reduced operational budget" },
          { type: "bureaucraticLeverage", value: 1, description: "Gain respect for restraint" }
        ]
      }
    ]
  },
  {
    ...
    description: "A rival daemon corporation is trying to acquire your operations. How do you respond?",
    type: "choice" as const,
    choices: [
      {
        label: "Fight Back",
        ...
        effects: [
          { type: "soulEssence", value: -1, description: "Burn essence for power" },
          { type: "morale", value: 15, description: "Daemons rally to the cause" },
      ...
      },
      {
        ...
        effects: [
          { type: "bureaucraticLeverage", value: 2, description: "Gain political connections" },
          { type: "daemon_retirement", value: 1, description: "One daemon transferred away" }
        ]
      }
    ]
  },
  {
    ...
    description: "Hell's Revenue Service is conducting a thorough investigation of your books.",
    type: "automatic" as const,
    effects: [
      { type: "credits", value: -100, description: "Audit fees and penalties" },
      { type: "equipment_durability", value: -10, description: "Equipment seized temporarily" },
  ...
  },
  {
    ...
    description: "Your department is merging with the Circles of Bureaucratic Excellence.",
    type: "automatic" as const,
    effects: [
      { type: "recruitment_discount", value: 0.5, description: "Half-price recruitment for 3 days" },
      { type: "bureaucraticLeverage", value: 5, description: "Enhanced political connections" },
      { type: "office_politics", value: 1, description: "Increased workplace drama" }
    ]
  },
  {
    ...
    effects: [
      ...
      { type: "equipment_discount", value: 0.3, description: "30% off equipment repairs" }
    ]
  },
  {
    id: "mandatory_training",
    title: "Mandatory Sensitivity Training",
    description: "HR requires all staff to attend 'Workplace Harmony in the 9th Circle.'",
    type: "choice" as const,
    choices: [
      {
        ...
        effects: [
          ...
          { type: "bureaucraticLeverage", value: 1, description: "HR brownie points" },
          { type: "productivity_bonus", value: 0.1, description: "10% mission bonus for 5 missions" }
        ]
      },
      {
        ...
        effects: [
          { type: "morale", value: 8, description: "Daemons appreciate the rebellion" },
          { type: "hr_investigation", value: 1, description: "HR scrutiny increases" }
        ]
      }
    ]
  },
  {
    ...
    type: "automatic" as const,
    effects: [
      { type: "equipment_upgrade", value: 1, description: "One random equipment gets +20 durability" },
  ...
  },
  {
    ...
    description: "A senior management position has opened up. Do you pursue it?",
    type: "choice" as const,
    ...
    choices: [
      {
        ...
        effects: [
          { type: "bureaucraticLeverage", value: -5, description: "Spend political capital" },
          { type: "passive_income", value: 50, description: "Earn 50 credits per day" },
          { type: "management_stress", value: 1, description: "All daemons lose 1 lifespan/day" }
        ]
      },
      {
        ...
        effects: [
          { type: "morale", value: 5, description: "Less pressure on the team" },
    ...
    choices: [
      {
        ...
        effects: [
          { type: "bureaucraticLeverage", value: 2, description: "Make valuable connections" },
          { type: "credits", value: -30, description: "Gift and outfit expenses" }
        ]
      },
      {
        ...
        effects: [
          { type: "research_progress", value: 1, description: "Advance equipment research" },
      ...
      },
      {
        ...
        effects: [
          { type: "morale", value: 12, description: "Team loves your leadership" },
          { type: "bureaucraticLeverage", value: 1, description: "Impress management" },
          { type: "stress", value: 1, description: "One daemon loses 2 health" }
        ]
      }
    ]
  }
