...
export interface ResourceActions {
  ...
  // Resource tracking
  getResourceHistory: (resourceType?: keyof GameResources) => ResourceState['resourceHistory'];
...
export const createResourceSlice: StateCreator<ResourceSlice, [], [], ResourceSlice> = (
  set,
  get
) => ({
  // Initial state
