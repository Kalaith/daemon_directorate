...
const TeamStatsCard = memo(() => {
  ...
  const gradientClass = useMemo(() => {
    ...
    if (stats.lowHealthCount > 0 || stats.lowMoraleCount > 0)
  ...
  return (
    <div className="space-y-6" role="main" aria-label="Corporate Dashboard">
      ...
      <section aria-labelledby="status-header">
        <h2 id="status-header" className="sr-only">
      ...
      <section aria-labelledby="team-status">
        <h2 id="team-status" className="sr-only">
          Team Status
        </h2>
        <TeamStatsCard />
      </section>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <section aria-labelledby="corporate-ladder">
          <h2 id="corporate-ladder" className="text-xl font-semibold mb-4">
        ...
        <section aria-labelledby="compliance-center">
          <h2 id="compliance-center" className="text-xl font-semibold mb-4">
        ...
        <section aria-labelledby="hall-of-infamy">
          <h2 id="hall-of-infamy" className="text-xl font-semibold mb-4">
            Legacy Records
          </h2>
          <HallOfInfamy />
        </section>
        ...
        <section aria-labelledby="corporate-rivals">
          <h2 id="corporate-rivals" className="text-xl font-semibold mb-4">
            Corporate Rivals
          </h2>
          <CorporateRivals />
        </section>
